...
qsearch.Source = "SELECT ProductID, ProductName, Supplier, Author, sImgUrl, Price, ListPrice  FROM Products  WHERE HotDeal=1  ORDER BY AddDate DESC"
    ...
    <tr> 
      <td bgcolor="#FFCC66" height="22"> 
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td>　<a href="default.asp" class="red">首页</a> &gt; 特价商品</td>
            <td>&nbsp;</td>
          </tr>
        </table>
      </td>
...
%>
          <td> 
            <table width="380" border="0" cellspacing="2" cellpadding="2">
              <tr> 
                <td rowspan="4" align="left" valign="top"><A HREF="product.asp?<%= MM_keepNone & MM_joinChar(MM_keepNone) & "ProductID=" & qsearch.Fields.Item("ProductID").Value %>"><img src="images/product/<%=(qsearch.Fields.Item("sImgUrl").Value)%>" border="0"></A></td>
              ...
              <tr> 
                <td width="255" valign="middle">原价：<span class="hotPrice"><%=(qsearch.Fields.Item("Price").Value)%></span>元 现价：<%=(qsearch.Fields.Item("ListPrice").Value)%>元</td>
              </tr>
            </table>
          </td>
          <%
