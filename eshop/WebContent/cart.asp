...
If (CStr(Request("UC_EmptyCart")) = "1") Then
  UCCart1.Destroy()
  UC_redirectPage = "cartisempty.asp"
...
End If
%>
<% If UCCart1.GetItemCount() <= 0 Then Response.Redirect("cartisempty.asp") %>
<html>
<head>
<title>网上商城</title>
    ...
    <td> 　　　　<img src="images/yourcart.gif" width="190" height="30"> 
      <form name="form1" method="post" action="<%=UC_updateAction%>">
        <table width="98%" border="0" cellspacing="2" cellpadding="2" align="center">
          ...
          <tr align="center" valign="middle"> 
            <td width="27%"><%=(UCCart1.GetColumnValue("ProductID",UCCart1__i))%></td>
            <td width="34%"><%=(UCCart1.GetColumnValue("ProductName",UCCart1__i))%></td>
            <td width="11%"><%=(UCCart1.GetColumnValue("Price",UCCart1__i))%>元</td>
            <td width="10%"> 
              <input type="text" name="textfield" size="8" maxlength="8" value="<%=(UCCart1.GetColumnValue("Quantity",UCCart1__i))%>">
            </td>
            <td width="18%"><%=(UCCart1.GetColumnValue("Total",UCCart1__i))%>元</td>
          </tr>
          <% Next 'UCCart1__i %>
          <tr align="center" valign="middle"> 
          ...
          <tr> 
            ...
            <td colspan="2"><%=(UCCart1.GetColumnTotal("Total"))%>元</td>
          </tr>
          <tr align="center" valign="baseline"> 
            <td></td>
            <td colspan="2">
              <input type="image" border="0" name="imageField" src="images/updatecart.gif" width="87" height="24">
              　　　<A HREF="<%=UC_EmptyCart%>"><img border=0 src="images/emptycart.gif" width="87" height="24"></A></td>
            <td colspan="2"><a href="userlogin.asp"><img src="images/check.gif" width="120" height="35" border="0"></a></td>
          </tr>
        </table>
      </form>
    </td>
