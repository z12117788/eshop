...
qsearch.Source = "SELECT ProductID, ProductName, Supplier, Author, sImgUrl  FROM Products  WHERE Commend=1  ORDER BY AddDate DESC"
    ...
    <tr> 
      <td bgcolor="#FFCC66" height="22"> 
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td>　<a href="default.asp" class="red">首页</a> &gt; 重点推荐</td>
            <td>&nbsp;</td>
          </tr>
        </table>
      </td>
