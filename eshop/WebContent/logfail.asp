...
<table width="760" border="0" cellspacing="1" cellpadding="0" align="center" bgcolor="#000000">
  <tr>
    <td bgcolor="#FFFFFF"> 
      <p>　　　<img src="images/loginfail.gif" width="190" height="30"></p>
      <p align="center" class="productName">登录失败！请填入正确的Email地址及密码.</p>
      <p align="center" class="productName"><a href="javascript:history.back(1)">返回</a></p>
      <p>&nbsp;</p>
    </td>
  </tr>
</table>
